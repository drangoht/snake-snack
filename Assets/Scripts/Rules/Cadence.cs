...
namespace SnakeSnack.Rules
{
    ...
    public static class Cadence
    {
        ...
        /// <summary>
        /// Découpe un temps accumulé en nombre entier de ticks, et rend le reliquat.
        /// </summary>
        ...
        /// <param name="reste">Reliquat à reporter sur l'image suivante.</param>
        /// <remarks>
        /// Le reliquat est <b>reporté, pas jeté</b> : remettre l'accumulateur à zéro à chaque tick
        /// fait dériver la cadence réelle vers le bas dès que le pas d'image ne divise pas la durée
        /// du tick (à 60 Hz, 125 ms tombe entre deux images). Une dérive de quelques pourcents ne
        /// lève rien mais fausse toute mesure de durée de partie.
        /// </remarks>
        public static int NombreDeTicks(double tempsAccumuleSecondes, double dureeTickSecondes, out double reste)
        {
            ...
            int ticks = (int)(tempsAccumuleSecondes / dureeTickSecondes);
            reste = tempsAccumuleSecondes - (ticks * dureeTickSecondes);
            return ticks;
        }
    }
}
